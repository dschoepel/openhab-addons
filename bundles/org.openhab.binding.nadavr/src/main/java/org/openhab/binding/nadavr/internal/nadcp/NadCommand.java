...
public enum NadCommand {
    ...
    TUNER_XM_CHANNEL_SONG_NAME_QUERY("", "XM.Name", "?", ""),
    TUNER_XM_CHANNEL_SONG_NAME_SET("", "XM.Name", "=", "%s"),
    TUNER_XM_CHANNEL_SONG_TITLE_QUERY("", "XM.Title", "?", ""),
    TUNER_XM_CHANNEL_SONG_TITLE_SET("", "XM.Title", "=", "%s"),
